            ...
            <main className="flex-grow">
                {isAdminOpen ? (
                    ...
                    <div>
                        ...
                        <div
                            id="about"
                            className="bg-white border-b border-nat-border py-12"
                        >
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                                    {[
                                        {
                                            icon: (
                                                <BookOpen className="h-6 w-6 text-nat-sage" />
                                            ),
                                        ...
                                        {
                                            icon: (
                                                <Users className="h-6 w-6 text-nat-terracotta" />
                                            ),
                                        ...
                                        {
                                            icon: (
                                                <Trophy className="h-6 w-6 text-nat-heading" />
                                            ),
                                        ...
                                        <div
                                            key={index}
                                            className="flex gap-4 p-4 rounded-2xl transition-all hover:bg-nat-light-card"
                                        >
                                            ...
                                            <div className="space-y-1 text-left">
                                                <h3 className="font-serif font-bold text-nat-heading text-sm">
                                                    {feat.title}
                                                </h3>
                                                <p className="font-sans text-xs text-nat-desc leading-relaxed">
                                                    {feat.desc}
                                                </p>
                                            </div>
                                        </div>
